...
public final class HealthGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest,
      com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse> getCheckMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Check",
      requestType = com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest.class,
      responseType = com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest,
      com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse> getCheckMethod() {
    io.grpc.MethodDescriptor<com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest, com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse> getCheckMethod;
    if ((getCheckMethod = HealthGrpc.getCheckMethod) == null) {
      synchronized (HealthGrpc.class) {
        if ((getCheckMethod = HealthGrpc.getCheckMethod) == null) {
          HealthGrpc.getCheckMethod = getCheckMethod =
              io.grpc.MethodDescriptor.<com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest, com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Check"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest,
      com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse> getWatchMethod;
  ...
  public static io.grpc.MethodDescriptor<com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest,
      com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse> getWatchMethod() {
    io.grpc.MethodDescriptor<com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest, com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse> getWatchMethod;
  ...
  public static abstract class HealthImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void check(com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest request,
        io.grpc.stub.StreamObserver<com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCheckMethod(), responseObserver);
    }

    /**
     */
    public void watch(com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest request,
        io.grpc.stub.StreamObserver<com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest,
                com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse>(
                  this, METHODID_CHECK)))
          .addMethod(
            getWatchMethod(),
  ...
  public static final class HealthBlockingStub extends io.grpc.stub.AbstractBlockingStub<HealthBlockingStub> {
    ...
    /**
     */
    public com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse check(com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest request) {
    ...
    /**
     */
    public java.util.Iterator<com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse> watch(
        com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest request) {
  ...
  public static final class HealthFutureStub extends io.grpc.stub.AbstractFutureStub<HealthFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse> check(
        com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK:
          serviceImpl.check((com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse>) responseObserver);
          break;
        case METHODID_WATCH:
          serviceImpl.watch((com.sunpe.grpc_with_consul.server.proto.HealthCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.sunpe.grpc_with_consul.server.proto.HealthCheckResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HealthBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.sunpe.grpc_with_consul.server.proto.HealthOuterClass.getDescriptor();
    }
